...
show_completion_message() {
    ...
    case $SETUP_MODE in
        development)
            ...
            echo -e ""
            echo -e "  3. Or start all at once: ${CYAN}npm run dev${NC}"
            echo -e ""
    ...
    echo -e "  • Project setup: ${CYAN}./doc/README.md${NC}"
    echo -e "  • Notifications: ${CYAN}./doc/RabbitMQ-Notification-System-Guide.md${NC}"
}
